...
(function(root, factory) {
    ...
    pipwerks.SCORM.API.get = function() {
        ...
        // srini -- for scorm cloud
        if (!API && win.opener.opener.top) {
            API = find(win.opener.opener.top);
        }

        if (!API && win.opener.opener) {
            API = find(win.opener.opener);
        }
            ...
            if (API) {
                ...
                switch (scorm.version) {
                    case "1.2":
                        ...
                        trace(traceMsgPrefix + " called - " + success);
                        break;
                    case "2004":
    ...
    pipwerks.UTILS.trace = function(msg) {
        ...
        if (pipwerks.debug.isActive) {
            ...
            if (window.console && window.console.log) {
                window.console.log("SCORM Log: " + msg);
            } else {
                //alert(msg);
            }
