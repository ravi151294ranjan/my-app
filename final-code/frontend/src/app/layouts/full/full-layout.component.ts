...
/**
 * Full layout describe layout withot navigation bar and side pannel.
 */
export class FullLayoutComponent implements OnInit, AfterViewInit {
  ...
  options = {
    direction: 'ltr',
    bgColor: 'black',
    bgImage: 'assets/img/sidebar-bg/7.png'
  };
  hideSidebar: boolean;
  iscollapsed = false;
  isSidebar_sm = false;
...
/**
 * layout change like dark layout  or Transparent layout in full layout
 */
  ngAfterViewInit() {
    setTimeout(() => {
