...
/**
 * PasswordStrengthValidator method used to validate the password strength.
 * @param control value of textbox
 */
export const PasswordStrengthValidator = function (control: AbstractControl): ValidationErrors | null {
  ...
  if (numberCharacters.test(value) === false) {
    return { passwordStrength: `text has to contine number.` };
  }
