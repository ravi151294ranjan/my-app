...
export class DashboardComponent implements OnInit, DoCheck {
  ...
  // @ViewChild('addChapterBtn') addChapterBtn: ElementRef<HTMLElement>;
  // @ViewChild('contentDesc') contentDesc;
  ...
  constructor(
    ...
    this.addContentForm = this.formBuilder.group({
      ...
      contentVideo: ['', Validators.required],
  ...
  finalData(): void {
    ...
    finalData['type'] = 'video';
    finalData['path'] = this.videoContentSrc;
    finalData['chapters'] = this.chapters;
    finalData['glossary'] = document.getElementById('glossary')['value'].split("\n").filter(function(v){return v!==''});
    finalData['glossary'] = finalData['glossary'].join()
